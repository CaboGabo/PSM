...
<head>
    ...
    <meta content="sillas apilables y sillas para visita o auxiliares" name="description">
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
    <title>Sillas apilables y de visita</title>
...
<body>
    ...
    <div class="container backgroundWorkArea">
            <h2 class="text-center">Sillas apilables, de visita y auxiliares</h2>
            <div class="row color text-center">
                <?php
                    $resultados = consultarCategoria(2, $conexion); 
