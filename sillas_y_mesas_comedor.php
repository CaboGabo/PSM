...
<head>
    ...
    <meta content="sillas y mesas para comedor, en color a elegir y cubiertas de mesas en varias medidas" name="description">
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
    <title>Sillas y mesas para comedor</title>
...
<body>
    ...
    <div class="container backgroundWorkArea">
            <h2 class="text-center">Sillas y mesas para comedor con estructuras cromadas o esmaltadas</h2>
            <div class="row color text-center">
                <?php
                    $resultados = consultarCategoria(4, $conexion); 
