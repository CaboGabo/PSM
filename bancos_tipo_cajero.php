...
<head>
    ...
    <meta content="bancos tipo cajero de altura ajustable, con arillo posapie. Ideal para mostrador, recepcion y cajeros" name="description">
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
    <title>Bancos tipo cajero</title>
...
<body>
    ...
    <div class="container backgroundWorkArea">
            <h2 class="text-center">Bancos tipo cajero, ideales para mostrador, bancos e industria</h2>
            <div class="row color text-center">
                <?php
                    $resultados = consultarCategoria(8, $conexion); 
